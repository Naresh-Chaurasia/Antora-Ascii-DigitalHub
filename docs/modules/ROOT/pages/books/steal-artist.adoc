...
<div class="dashboard">
  ...
  <div class="card">
    ...
    <ul>
      ...
      <li>Javier Escobar is on another level. Someday I will come back to him. For now, let me watch him move on the dance floor and enjoy.</li>
    </ul>
  </div>
...
== 🧭 2. Don't Wait Until You Know Who You Are to Get Started | ✔️
...
<div class="dashboard">
  ...
  <div class="card">
    <h3>🚀 Action Items | Dance</h3>
    <ul>
      <li>Start with Shines Routines | You have enough content for Partner Work.</li>
      <li>Start Working on Musicality.
        <div class="comment">2 Salsa and 2 Bachata songs in 1 Month is doable. Drill with Musicality</div>
        <div class="comment">Review existing content. Document it.</div>
      </li>
    </ul>
  </div>
...
== 📚 3. Write the Book You Want to Read | ✔️
...
"Nothing comes from nowhere. All creative work builds on what came before. Nothing is completely original. Every new idea is just a mashup or a remix of one or more previous ideas."
  ...
  <div class="card">
    ...
    <ul>
      <li>Dance The Dance you want to see.
        <div class="comment">Mix Up Things | Choreograph Your 1st Routine and Drill it.</div>
      </li>
    </ul>
  </div>
  <div class="card">
    <h3>🚀 Action Items | Dance</h3>
    <ul>
      <li>3 Shines Attributed to me !!!</li>
    </ul>
  </div>
</div>
++++
...
> Start shooting. Looking Yourself in camera will help. You will know where you are making mistakes | Inch By Inch
